...
const About = () => {
  return (
    <div className="bg-gradient-to-b from-black to-gray-900 h-fit">
      ...
      <div className="p-5 flex max-md:flex-col justify-around   m-5 rounded-md">
        <p className="text-white w-1/2 max-md:w-full max-md:order-1 max-md:mt-2">
          Hello there, I Am Rutvik Amarcholi working as a
          <b>Sr.MERN Stack Developer</b> with <b>1 year</b> of experience.I
          ...
          also tried Blender software and other animation softwares.Also i can
          learn thing faster and can easily addopt new Environment.
          <br />
          <br />
